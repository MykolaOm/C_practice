...
const char *keywords[]= {
       ...
       "WHEN","WHY",
       "NAME","CAUSE","SORRY","STUDENT","HELLO","HI ","MAYBE",
...
const char *responses[NUMKEYWORDS][9] = { 
    ...
    {   "WHAT DOES THAT SUGGEST TO YOU?",
        "DO YOU THINK ABOUT STUDING IN ITA OFTEN?",
        "WHAT DIRECTION YOU PREFARE TO CHOOSE?",
        "WHY ARE YOU NOT STUDY IN ITA?"},
    ...
    {   "SAY, DO YOU HAVE ANY INFORMATION ABOUT IT-ACADEMY?",
        "WHAT DOES THAT SUGGEST TO YOU?",
        "I SEE.",
...
void print_title () {
    printf("\n\n");
    print_center("*** ITABOT ***");
    //print_center("by Omelianov");
    print_center("To stop ITABOT, type 'bye'");
    printf("\n\n");
    printf("HI!  I'M ITABOT. HOW DO YOU DO?\n");
}
...
void ChatBot() //main -------- for 123.cpp.
{
    ...
    while (1) { 
        ...
        // Build ITABOT'S response 
        // start with ITABOT'S canned response, based on the keyword match
